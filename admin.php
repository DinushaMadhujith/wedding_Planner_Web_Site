...
$(document).ready(function(){  
    ...
    /*
	function edit_data(id, name, email, address, p_number, posision, job, column_name)  
    {  
        $.ajax({  
            url:"edit.php",  
            method:"POST",  
            data:{id:id, name:name, email:email, address:address, p_number:p_number, posision:posision, job:job, column_name:column_name},  
            dataType:"text",  
            success:function(data){  
                //alert(data);
